...
bool LoRaWANClass::init(void)
{
    ...
    // Rx
#if defined(AS_923)
    LoRa_Settings.Datarate_Rx = SF9BW125;   //set to SF10 BW 125 kHz
...
void LoRaWANClass::setDevAddr(String devAddr_in)
{
...
{
    if(channel==0)return 921200000;
    else if(channel==1)return 921400000;
    else if(channel==2)return 921600000;
    else if(channel==3)return 921800000;
    else if(channel==4)return 922000000;
    else if(channel==5)return 922800000;
    else if(channel==6)return 921200000;
    else if(channel==7)return 921400000;
}
