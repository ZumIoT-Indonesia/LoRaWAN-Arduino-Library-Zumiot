 ...
 */
  ...
  static const PROGMEM unsigned char  LoRa_Frequency[9][3] = {//[921.2 - 922.6] MHz
    { 0xE6, 0x4C, 0xF3 }, //Channel [0], 921.2 MHz / 61.035 Hz = x = 0xE64CF3
    { 0xE6, 0x59, 0xC0 }, //Channel [1], 921.4 MHz / 61.035 Hz = x = 0xE659C0
    { 0xE6, 0x66, 0x8D }, //Channel [2], 921.6 MHz / 61.035 Hz = x = 0xE6668D
    { 0xE6, 0x73, 0x5A }, //Channel [3], 921.8 MHz / 61.035 Hz = x = 0xE6735A
    { 0xE6, 0x80, 0x27 }, //Channel [4], 922.0 MHz / 61.035 Hz = x = 0xE68027
    { 0xE6, 0xB3, 0x59 }, //Channel [5], 922.2 | 922.8 MHz / 61.035 Hz = x = 0xE68CF3 | E6B359
    { 0xE6, 0x4C, 0xF3 }, //Channel [6], 921.2 MHz / 61.035 Hz = x = 0xE64CF3
    { 0xE6, 0x59, 0xC0 }, //Channel [7], 921.4 MHz / 61.035 Hz = x = 0xE659C0
  };
#endif
